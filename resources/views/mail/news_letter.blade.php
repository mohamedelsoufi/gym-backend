                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                style="padding:20px;Margin:0"><h4
                                                                    style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'trebuchet ms', helvetica, sans-serif;font-size:18px">{{settings()->website_title}}</h4>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
