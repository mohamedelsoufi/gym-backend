...
@section('title', settings()->website_title . ' | ' . __('words.create_class_schedule'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.create_class_schedule') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
...
@section('form_action', route('schedules.store'))
    ...
    <div class="card card-custom">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{ __('words.create_class_schedule') }}</h3>
            </div>
        </div>
