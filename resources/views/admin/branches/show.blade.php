...
@section('title', settings()->website_title . ' | ' . __('words.show_branch'))
@section('breadcrumb')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-7 bg-light p-5 rounded h-100">
                                    ...
                                    {!! $branch->translate($locale)->description !!}
                                </div>
                            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0"><span class="badge rounded-pill text-white {{$branch->status == 1 ? 'bg-success' : 'bg-danger'}}">{{ $branch->getActive() }}</span></p>
                        </div>
                    </div>
                </div>
