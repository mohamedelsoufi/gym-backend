...
@section('title', settings()->website_title . ' | ' . __('words.days'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.show_days') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title">{{ __('words.show_days') }}</h3>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <a href="{{ route('days.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="custom_datatable">
                ...
                @foreach ($days as $key => $day)
                    <tr>
                        ...
                        <td>{{ formatDate($day->created_at) == formatDate($day->updated_at) ? '--' : formatDate($day->updated_at) }}
                        </td>
                        <td nowrap="nowrap">
