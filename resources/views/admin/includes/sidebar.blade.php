        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ request()->routeIs('features.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fas fa-feather-alt svg-icon menu-icon"></i>
                ...
                <li class="menu-item menu-item-submenu {{ request()->routeIs('branches.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fas fa-code-branch svg-icon menu-icon"></i>
                        <span class="menu-text">{{__('words.branches')}}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            @permission('read-branches')
                            <li class="menu-item  {{ request()->routeIs('branches.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item  {{ request()->routeIs('branches.create') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                ...
                {{-- branch routes start --}}
                @permission('read-branch_points')
                <li class="menu-item menu-item-submenu {{ request()->routeIs('branch-points.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item  {{ request()->routeIs('pages.edit') ? 'menu-item-active' : '' }}"
                                ...
                                <a href="{{route('pages.edit',\App\Models\Page::where('identifier','branch_view')->first())}}"
                                   class="menu-link">
                                    ...
                                    <span class="menu-text">{{__('words.nile_view')}}</span>
                                </a>
                            </li>
                            @endpermission

                            @permission('read-branch_points')
                            <li class="menu-item  {{ request()->routeIs('branch-points.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('branch-points.index')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('words.show_all')}}</span>
                            ...
                            @permission('create-branch_points')
                            <li class="menu-item  {{ request()->routeIs('branch-points.create') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('branch-points.create')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('words.create')}}</span>
...
{{--                <li class="menu-item menu-item-submenu {{ request()->routeIs('comments.*') ? 'menu-item-open menu-item-here' : '' }}"--}}
{{--                    aria-haspopup="true" data-menu-toggle="hover">--}}
{{--                    <a href="javascript:;" class="menu-link menu-toggle">--}}
{{--                        <i class="fas fa-comment-dots svg-icon menu-icon"></i>--}}
{{--                        <span class="menu-text">{{__('words.comments')}}</span>--}}
{{--                        <i class="menu-arrow"></i>--}}
{{--                    </a>--}}
{{--                    <div class="menu-submenu">--}}
{{--                        <i class="menu-arrow"></i>--}}
...
{{--                            @permission('read-comments')--}}
{{--                            <li class="menu-item  {{ request()->routeIs('comments.index') ? 'menu-item-active' : '' }}"--}}
{{--                                aria-haspopup="true">--}}
...
{{--                @endpermission--}}
                ...
                <li class="menu-item menu-item-submenu {{ request()->routeIs('events.*') ? 'menu-item-open menu-item-here' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <i class="fas fa-calendar-day svg-icon menu-icon"></i>
                        <span class="menu-text">{{__('words.events')}}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            @permission('read-events')
                            <li class="menu-item  {{ request()->routeIs('events.index') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item  {{ request()->routeIs('events.create') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            @permission('subscribers-events')
                            <li class="menu-item  {{ request()->routeIs('events.subscribers') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{route('events.subscribers')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{__('words.subscribers')}}</span>
                                </a>
                            </li>
                            @endpermission
                        </ul>
