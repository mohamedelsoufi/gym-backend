...
@section('title', settings()->website_title . ' | ' . __('words.classes'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.show_classes') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-title">{{ __('words.show_classes') }}</h3>
            </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <a href="{{ route('classes.create') }}" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="custom_datatable">
                ...
                @foreach ($classes as $key => $class)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <a href="{{$class->image}}"
                                   data-toggle="lightbox" data-title="{{$class->title}}"
                                   data-gallery="gallery">
                                    <img class="index_image" src="{{ $class->image }}"
                                         onerror="this.src='{{ asset('uploads/default_image.png') }}'"
                                         alt="slider-image">
                                </a>
                            @endif
                        ...
                        <td>{{ formatDate($class->created_at) == formatDate($class->updated_at) ? '--' : formatDate($class->updated_at) }}
                        </td>
                        <td nowrap="nowrap">
